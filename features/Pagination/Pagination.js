...
//     update({ currentPage, totalPages, totalProducts, limit }) {
//         console.log('pagination update'); // Для отладки
...
//         this.paginationCurrent.textContent = width < totalProducts ? width : totalProducts;
//         this.paginationTotal.textContent = totalProducts;

//         // Обновляем ссылки и обработчики для кнопок пагинации
...
//         console.log('pagination updatePaginationButtons'); // Для отладки
//         this.paginationLeft.replaceWith(this.paginationLeft.cloneNode(true));
//         this.paginationRight.replaceWith(this.paginationRight.cloneNode(true));
//         this.paginationLeft = this.pagination.querySelector('.pagination__left');
//         this.paginationRight = this.pagination.querySelector('.pagination__right');

//         if (this.currentPage > 1) {
//             this.paginationLeft.classList.remove('pagination__disabled');
//             this.paginationLeft.addEventListener('click', (event) => {
//                 event.preventDefault();
//                 this.fetchAndRender(this.currentPage - 1);
//             });
//         } else {
//             this.paginationLeft.classList.add('pagination__disabled');
//         }

//         if (this.currentPage < this.totalPages) {
//             this.paginationRight.classList.remove('pagination__disabled');
//             this.paginationRight.addEventListener('click', (event) => {
//                 event.preventDefault();
//                 this.fetchAndRender(this.currentPage + 1);
//             });
//         } else {
//             this.paginationRight.classList.add('pagination__disabled');
//         }
//     }

//     createPagination() {
//         console.log('pagination createPagination'); // Для отладки
//         const pagination = document.createElement('div');
//         pagination.classList.add('pagination');
...
//         // Здесь реализуется логика получения данных и обновления страницы
//         // Предположим, что у тебя есть объекты api и productList
//         console.log('pagination fetchAndRender'); // Для отладки
...
//             if (category) {
//                 data = await api.getCategoryProducts({ slug: category, page });
//             } else if (q) {
//                 data = await api.getSearchProducts({ q, page });
//             } else {
//                 data = await api.getProducts({ page });
//             }

//             productList.update(data.products);
//             this.update({
...
//             const url = new URL(window.location.href);
//             url.searchParams.set('page', page);
//             console.log('Updated URL:', url.toString()); // Для отладки
//             history.pushState({}, '', url);
