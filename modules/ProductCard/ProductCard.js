...
//         const productliderMain = document.createElement('div');
//         productliderMain.classList.add('swiper', 'product__slider-main');
...
//             const productlide = document.createElement('div');
//             productlide.classList.add('swiper-slide', 'product__slide');
            
//             const productImage = document.createElement('img');
//             productImage.classList.add('product__image');
//             productImage.src = `${item}`;

//             productlide.append(productImage);
//             return productlide;
//         });

//         productMainList.append(...mainSliderItems);

//         productliderMain.append(productMainList);

//         productPicture.append(productliderMain);
...
//             productliderMain.append(productArrowNext, productArrowPrev);

//             const productliderThumbnails = document.createElement('div');
//             productliderThumbnails.classList.add(
//                 'swiper',
...
//             productliderThumbnails.append(productThumbnailsList);

//             const thumbnailsSliderItems = product.images.map((item) => {
//                 const productlide = document.createElement('div');
//                 productlide.classList.add(
//                     'swiper-slide',
...
//             productPicture.append(productliderThumbnails)
//         }
...
export class ProductCard {
    ...
    mount(parent, product) {
        console.log("Mounting ProductCard with product:", product);
        this.render(product);
        if (this.isMounted) {
            return;
        }
...
//     }
        ...
        if (images.length > 1) { //  if (product.images.length > 1) {
            const productArrowNext = document.createElement('button');
            productArrowNext.classList.add('product__arrow', 'product__arrow_next');
            productArrowNext.innerHTML = `
                <svg width="32" height="32" 
                ...
                `
            // productPicture.append(productArrowNext, productArrowPrev);
...
//             productPicture.append(productArrowNext);
//             productPicture.append(productArrowPrev);
//         }
...
//         this.containerElement.append(productPicture);
//         this.containerElement.append(desc);
//         console.log("Mounting ProductCard with product:", product);
//         console.log("ProductCard render product:", product);
//         console.log("ProductCard images:", images);
//     }
