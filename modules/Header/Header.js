...
// вторая версия, чата gpt с навигацией
// import { Logo } from "../../features/Logo/Logo";
// import { likeSvg } from "../../features/likeSvg/likeSvg";
// import { router } from "../../main";
// import { addContainer } from "../addContainer";
...
//             // Добавляем слушатель для изменения маршрутов
...
//         // Устанавливаем стиль header в зависимости от текущего маршрута
//         this.updateHeaderStyle(window.location.pathname);
//     }
...
//             this.updateHeaderStyle(newRoute);
//         });
//     }

//     updateHeaderStyle(route) {
//         // Если главная страница (укажи свои маршруты, если они отличаются)
//         if (route === '/') {
//             this.element.classList.add('header--transparent');
//             this.element.classList.remove('header--with-bg');
//         } else if (route === '/catalog') {
//             this.element.classList.add('header--with-bg');
